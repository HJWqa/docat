...
class CR3lLoader implements IDeviceLoader {
  ...
  public initWorkspace(scence: THREE.Scene) {
    //workspace
    this.workspace = new CrWorkspaceLoader({ radius: 1740, topRadius: 191 });
    this.workspace.position.set(0, -15, 0);
    this.workspace.scale.set(0.5, 0.5, 0.5);
  ...
  public initAxesHelper(scence: THREE.Scene) {
    ...
    this.axisHelp1.position.set(0, -570, 0);
    this.axisHelp1.scale.set(0.6, 0.6, 0.6);
    this.axisHelp1.add(this.base!);
    this.baseHelper.add(this.axisHelp1!);
    //J1
    this.axisHelp2 = new THREE.Object3D();
    this.axisHelp2.position.set(-22.5, 25, 0);
    this.axisHelp2.add(this.J1!);
    this.J1!.position.set(1817, -70, -594);
    //J2
    this.axisHelp3 = new THREE.Object3D();
    this.axisHelp3.position.set(-85, 106.5, 0);
    this.J2?.position.set(1903, -176, -594);
    this.axisHelp3.add(this.J2!);
    this.axisHelp3!.rotation.x = mathTool.transformDeg(-38);
    //J3
    this.axisHelp4 = new THREE.Object3D();
    this.axisHelp4.position.set(-43, 643.5, 487);
    this.J3!.position.set(1946, -819.5, -1081);
    this.axisHelp4.add(this.J3!);
    this.axisHelp4!.rotation.x = mathTool.transformDeg(80);
    // J4
    this.axisHelp5 = new THREE.Object3D();
    this.axisHelp5.position.set(5, 570.5, -528.5);
    this.J4!.position.set(1941, -1390, -552.5);
    this.axisHelp5.add(this.J4!);
    this.axisHelp5!.rotation.x = mathTool.transformDeg(45);
    //J5
    this.axisHelp6 = new THREE.Object3D();
    this.axisHelp6.position.set(-63.5, -0.5, -55);
    this.J5!.position.set(2004.5, -1389.5, -498);
    this.axisHelp6.add(this.J5!);
    this.axisHelp6!.rotation.z = mathTool.transformDeg(-90);
    // J6
    this.axisHelp7 = new THREE.Object3D();
    this.axisHelp7.position.set(0, -55, -61);
    this.J6!.position.set(2004.5, -1335, -437);
    this.axisHelp7.add(this.J6!);
    // toolEndPoint
    this.axisHelp8 = new THREE.Object3D();
    this.axisHelp8!.position.set(0, -50, 0);
    ...
    this.axisHelp8!.rotation.x = mathTool.transformDeg(90);

    // zeroGroupHelper
    this.zeroGroupHelper = new THREE.Object3D();
    this.axisHelp1!.add(this.zeroGroupHelper);
    this.zeroGroupHelper.position.set(-22.5, -45, 0);
  ...
  public show3DDTargetPosition(posData: number[]) {
    ...
    this.virtualAxisHelp3!.rotation.x = mathTool.transformDeg(
      -posData[1] - 38 || 0
    );
    this.virtualAxisHelp4!.rotation.x = mathTool.transformDeg(
      -posData[2] + 80 || 0
    );
    this.virtualAxisHelp5!.rotation.x = mathTool.transformDeg(
      -posData[3] + 45 || 0
    );
    this.virtualAxisHelp6!.rotation.z = mathTool.transformDeg(
      -posData[4] - 90 || 0
    );
    this.virtualAxisHelp7!.rotation.y = mathTool.transformDeg(-posData[5] || 0);
  }
  ...
  public animate(
    ...
    this.axisHelp3!.rotation.x = mathTool.transformDeg(-J2 - 38);
    this.axisHelp4!.rotation.x = mathTool.transformDeg(-J3 + 80);
    this.axisHelp5!.rotation.x = mathTool.transformDeg(-J4 + 45);
    this.axisHelp6!.rotation.z = mathTool.transformDeg(-J5 - 90);
    this.axisHelp7!.rotation.y = mathTool.transformDeg(-J6);
  ...
  public setAxisHelpSphere(data: any) {
    ...
    this.axisHelpSphere = mathTool.creatSphereMaterial(100);
    this.axisHelpSphere!.position.set(110, 0, 0);
